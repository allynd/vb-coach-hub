const CACHE='volleyball-coach-hub-v5';
const ASSETS=['./','./index.html','./coach.css','./coach.js','./history-delete.js','./db.js','./manifest.webmanifest','./icon-180.png','./icon-192.png','./icon-512.png'];
